...
export default function ComingSoon() {
  const countdown = useCountdown(new Date("12/15/2021"));
      ...
      <Box sx={{ maxWidth: 480, margin: "auto", textAlign: "center" }}>
        <CountdownStyle>
          <div>
            ...
            <Typography variant="body2" sx={{ color: "text.secondary" }}>Days</Typography>
          </div>
          ...
          <div>
            ...
            <Typography variant="body2" sx={{ color: "text.secondary" }}>Hours</Typography>
          </div>
          ...
          <div>
            ...
            <Typography variant="body2" sx={{ color: "text.secondary" }}>Seconds</Typography>
          </div>
        </CountdownStyle>
      </Box>
    </Container>
